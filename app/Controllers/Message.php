...
class Message extends BaseController
{
    ...
    public function processMessage()
    {
        try {
            ...
            $dataHistory = $this->conv->getAll($data['userId']);
            ...
            $prompt = 'Response have to be not make the response too long, no need to response completely, just response briefly, do not say the you are just an AI bot, Do not make paragraphs, just sentences, make the response more like the character, do not use her, make it more human so users can get emotional with the bot response, do not use the same format template in every response, you are tomoko, so do not mention "her". And the users says ' . $data['content'];
